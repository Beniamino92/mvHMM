...
This software is illustrated in `tutorial_mvHMM.Rmd`, where we show results from three different scenarios: 
...
We provide a snapshot of  `tutorial_MvHMM.Rmd` for using our (stan) software in R 
